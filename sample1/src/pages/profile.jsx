...
const Profile = () => {
    return (
        <> 
            ...
            <div className="min-h-[calc(100vh-4rem)] h-[80%] w-full flex flex-col md:flex-row justify-center items-center bg-[#f8bdc8] overflow-hidden">
            <div className=" mt-15 w-1/2 flex  justify-center items-center">
                ...
                <h1 className="text-5xl font-bold text-left leading-loose">Hi,I am <span className="text-[#881517] ">Rinisha Jesline T</span></h1>
